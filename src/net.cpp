...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rupinote " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"rupinotetools.com", "13.127.36.66"},
    {"13.127.46.218", "13.127.46.218"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"rupinotetools.com", "35.154.18.163"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rupinote is probably already running."), addrBind.ToString().c_str());
        else
